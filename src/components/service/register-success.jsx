                ...
                <div className='bg-white rounded-lg w-[80vw] sm:w-[70vw] md:w-[60vw] lg:w-[50vw] xl:w-[40vw] 2xl:w-[30vw] flex flex-col '>
                    ...
                    <div className='px-5 py-2 flex-1'>
                        ...
                        {[
                            ...
                            ['Giá khám dịch vụ:', `${(state.price * 26181).toLocaleString('vi-VN')} VNĐ`, !state.is_insurrance],
                            ['Giá khám bảo hiểm:', `${(state.price_insur * 26181).toLocaleString('vi-VN')} VNĐ`, state.is_insurrance],
