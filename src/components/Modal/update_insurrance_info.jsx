                ...
                <div className="min-w-[30vw]">
                    ...
                    <div className="flex flex-col bg-white overflow-y-auto px-4 min-w-[30vw] pt-3">
                        ...
                        <div className="flex flex-col p-1">
                            ...
                            <select name="ethnicity" defaultValue={"none"}  className="outline-none text-colorOne px-2 py-1 bg-colorBody hover:bg-slate-300 focus:bg-slate-300 rounded-lg" id="txtEthnicity">
                        ...
                        <div className="flex flex-col p-1">
                            ...
                            <select name="occupation" defaultValue={"none"} id="txtOccupation" className="outline-none text-colorOne px-2 py-1 bg-colorBody hover:bg-slate-300 focus:bg-slate-300 rounded-lg">
                    ...
                    <div className="flex justify-center items-center p-3 bg-white rounded-b-md">
                        <button className="px-3 py-1 bg-gradient-to-r from-colorTwo to-colorFive rounded-lg hover:from-green-500 hover:to-emerald-600 font-semibold text-white" onClick={() => navigate('/service')}>Bước tiếp theo</button>
                    </div>
                </div>
            </div>
        </>
